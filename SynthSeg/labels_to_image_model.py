...
def labels_to_image_model(labels_shape,
    ...
    :param res_uniform_per_axis: (optional) replace the stock iso/aniso resolution sampler by one
    independent uniform draw per axis in [atlas_res, max(max_res_iso, max_res_aniso)], keeping a
    probability res_prob_min of returning atlas_res on every axis. Off by default, which leaves the stock
